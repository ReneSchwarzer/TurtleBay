...
namespace TurtleBayNet.Plugin.Pages
{
    public sealed class PageSettings : PageBase
    {
        ...
        public override void Init()
        {
            ...
            {
                DayFromCtrl.Value = ViewModel.Instance.DayFrom.ToString();
                DayTillCtrl.Value = ViewModel.Instance.DayTill.ToString();
                NightMinCtrl.Value = ViewModel.Instance.NightMin.ToString();
                DayMinCtrl.Value = ViewModel.Instance.DayMin.ToString();
                MaxCtrl.Value = ViewModel.Instance.Max.ToString();
                FromCtrl.Value = ViewModel.Instance.From.ToString();
                TillCtrl.Value = ViewModel.Instance.Till.ToString();
                From2Ctrl.Value = ViewModel.Instance.From2.ToString();
                Till2Ctrl.Value = ViewModel.Instance.Till2.ToString();
            };

            Form.ProcessFormular += (s, e) =>
            {
                ViewModel.Instance.DayFrom = Convert.ToInt32(DayFromCtrl.Value);
                ViewModel.Instance.DayTill = Convert.ToInt32(DayTillCtrl.Value);
                ViewModel.Instance.NightMin = Convert.ToInt32(NightMinCtrl.Value);
                ViewModel.Instance.DayMin = Convert.ToInt32(DayMinCtrl.Value);
                ViewModel.Instance.Max = Convert.ToInt32(MaxCtrl.Value);
                ViewModel.Instance.From = Convert.ToInt32(FromCtrl.Value);
                ViewModel.Instance.Till = Convert.ToInt32(TillCtrl.Value);
                ViewModel.Instance.From2 = Convert.ToInt32(From2Ctrl.Value);
                ViewModel.Instance.Till2 = Convert.ToInt32(Till2Ctrl.Value);
